...
class AboutPage(BasePage):
    ...
    def get_device_name(self) -> str | None:
        ...
        label = self.get_attribute(self.NAME_CELL, "label", timeout=5)
    ...
    def get_ios_version(self) -> str | None:
        ...
        if self.is_element_present(self.IOS_VERSION_CELL, timeout=2):
            label = self.get_attribute(self.IOS_VERSION_CELL, "label")
            return self._extract_value_from_label(label)
        elif self.is_element_present(self.SOFTWARE_VERSION_CELL, timeout=2):
            label = self.get_attribute(self.SOFTWARE_VERSION_CELL, "label")
            return self._extract_value_from_label(label)
        return None
    ...
    def get_model_name(self) -> str | None:
        ...
        if self.is_element_present(self.MODEL_NAME_CELL):
            label = self.get_attribute(self.MODEL_NAME_CELL, "label")
            return self._extract_value_from_label(label)
        return None
    ...
    def get_model_number(self) -> str | None:
        ...
        if self.is_element_present(self.MODEL_NUMBER_CELL):
            label = self.get_attribute(self.MODEL_NUMBER_CELL, "label")
            return self._extract_value_from_label(label)
        return None
    ...
    def get_serial_number(self) -> str | None:
        ...
        if self.is_element_present(self.SERIAL_NUMBER_CELL):
            label = self.get_attribute(self.SERIAL_NUMBER_CELL, "label")
            return self._extract_value_from_label(label)
        return None
    ...
    def get_wifi_address(self) -> str | None:
        ...
        if self.is_element_present(self.WIFI_ADDRESS_CELL):
            label = self.get_attribute(self.WIFI_ADDRESS_CELL, "label")
            return self._extract_value_from_label(label)
        return None
    ...
    def get_storage_capacity(self) -> str | None:
        ...
        if self.is_element_present(self.CAPACITY_CELL):
            label = self.get_attribute(self.CAPACITY_CELL, "label")
            return self._extract_value_from_label(label)
        return None
    ...
    def get_available_storage(self) -> str | None:
        ...
        if self.is_element_present(self.AVAILABLE_CELL):
            label = self.get_attribute(self.AVAILABLE_CELL, "label")
            return self._extract_value_from_label(label)
        return None
